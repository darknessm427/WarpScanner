...
def info():
    ...
    table.add_row("darkness_427","1 - Telegram")
    table.add_row("daeknessm427","2 - github")
    console.print(table)
    ...
    if whats2=='0':
    	...
    	os.system("termux-open-url 'https://github.com/darknessm427/WaroScanner/tree/main'")
...
{{
        ...
        "outbounds": [
                ...
                "tag": "select",                                           "outbounds": [
                        "auto",
                        "IP->Iran, @darkness_427",
                        "IP->Main, @darkness_427"
                ],
                "default": "auto"
                }},
                {{
                ...
                {{
                "type": "wireguard",
                "tag": "IP->Main, @darkness_427",
                "detour": "IP->Iran, @darkness_427",
                "local_address": [
                        "172.16.0.2/32",
                        "{all_key2[0]}"
                ],
...
def generate_wireguard_url(config, endpoint):
    ...
    wireguard_urll += "#Tel=@ÐΛɌ₭ᑎΞ𐒡𐒡_427"
